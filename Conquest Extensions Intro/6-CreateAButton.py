##########
#
# STEP 6: THIS SCRIPT CREATS A BUTTON WHICH CHECKS IF THERE ARE ADDRESS FIELDS ENTERED, AND IF SO GENERATES A LOCATION STRING AND PLACES IT IN THE LOCATION FIELD
...
def btn_GenerateLocationClick(sender, e):
	...
	if not String.IsNullOrWhiteSpace(Location):
		...
		p("There's no data to pop the location field with.")
...
locationButton.Click += btn_GenerateLocationClick
