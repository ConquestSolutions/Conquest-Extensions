##########
#
# THIS SCRIPT CHECKS IF THERE IS ANYTHING IN THE LOCATION FIELD, IF THERE IS IT WILL SEND A REQUEST TO THE GOOGLE GEOCOORDINATES API AND TRY AND RETRIEVE GEOCOORDINATES
