##########
#
# THIS SCRIPT CREATS A BUTTON WHICH CHECKS IF THERE ARE ADDRESS FIELDS ENTERED, AND IF SO GENERATES A LOCATION STRING AND PLACES IT IN THE LOCATION FIELD
